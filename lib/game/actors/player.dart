...
import 'package:flutter_game/game/utils/audio_manager.dart';
...
class Player extends SpriteComponent with CollisionCallbacks, KeyboardHandler {
  ...
  bool onKeyEvent(KeyEvent event, Set<LogicalKeyboardKey> keysPressed) {
    ...
    _hAxisInput += keysPressed.contains(LogicalKeyboardKey.digit2) ? -1 : 0;
    _hAxisInput += keysPressed.contains(LogicalKeyboardKey.digit8) ? 1 : 0;
    _jumpInput = keysPressed.contains(LogicalKeyboardKey.digit6);
    return true;
  }
